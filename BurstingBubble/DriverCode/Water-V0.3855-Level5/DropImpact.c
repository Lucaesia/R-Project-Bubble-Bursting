...
/* event extractPressureData (t = 0.0; t += 0.1) {
  fprintf(stdout, "extractPressureData\n");
...
event movies (t += 0.05){
  ...
  fprintf(stdout, "movies 6\n");
  view(width=1900, height=1050, fov=7.0, ty = 0.0, quat = { 0, 0, -0.707, 0.707 });
  fprintf(stdout, "movies 7\n");
  clear();
  fprintf(stdout, "movies 8\n");
