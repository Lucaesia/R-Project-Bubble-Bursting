...
for R in 0.0032 ; do
    ...
    cp MasterImpact/DropImpact.c Water-R$R-Level$LEVEL/DropImpact.c
    ...
    echo "RUNNING R: $R  LEVEL: $LEVEL"
		...
		./DropImpact 998.0 1.21 0.998e-3 1.81e-5 0.0722 9.81 $R 1 0.5 $LEVEL 4.0
